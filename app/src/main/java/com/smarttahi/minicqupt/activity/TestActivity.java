...
import com.smarttahi.minicqupt.adapter.mAdapter;

import java.util.ArrayList;

public class TestActivity extends BaseActivity implements Contract.MvpView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                showDialog("You have login, do you want to logout?");
            }
        });
    }
    ...
    public void showDialog(String s) {
        ...
        //设置title
        normalDialog.setTitle("Logout");
        //设置icon
        normalDialog.setIcon(R.drawable.ten);
        //设置内容
